...
##Subset data to test for IGF1 and IGF2 expression level changes over time across the entire developmental series.A random command is added to account for the triplicate measures during qPCR analysis.
